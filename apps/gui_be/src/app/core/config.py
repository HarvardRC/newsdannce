...
# WEIGHTS: COM/DANNCE trained weights
# PREDICTIONS: COM/DANNCE prediction data
# VIDEO_FOLDERS: imported video folders
# CONFIGS: Dannce/COM config files
# JOB_LOGS: job logs used in training, infererence. Generated by SLURM or local processes
# LOGS: general app logs (e.g. logging package, debug logs, etc.)
...
class _Settings(BaseSettings):
    ...
    JOB_LOGS_FOLDER: Path = Path(DATA_FOLDER, "job_logs")
