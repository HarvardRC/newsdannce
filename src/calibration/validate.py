# functions to validate the calibration paramters after they have been generated
# mostly used from the GUI
...
class ValidationMediaFormat(Enum):
    TIFF = "tiff"
    VIDEO = "video"
...
def do_validate(
    ...
    validate_dir_format=ValidationMediaFormat.VIDEO,
    visualize=True,
):
    ...
    if validate_dir_format == ValidationMediaFormat.TIFF:
    ...
    elif validate_dir_format == ValidationMediaFormat.VIDEO:
...
if __name__ == "__main__":
    ...
    validate_dir_format = ValidationMediaFormat(args.validate_dir_format)
