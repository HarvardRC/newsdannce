...
for kk = 1 : numcams
    ...
    [params_individual{kk}, pairsUsed, estimationErrors{kk}] = estimateCameraParametersPar( ...
            imagePoints{kk}(:, :, imageNums{kk}), worldPoints, ...
...
for kk = 1 : numcams
    ...
    imagesc(im);
    subplot(122);
    imagesc(undistortImage(im, params_individual{kk}));
end
